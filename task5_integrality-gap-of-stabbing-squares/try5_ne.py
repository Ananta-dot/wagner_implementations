...
def build_traversal_graph(n):
    """
    Build a DAG for one dimension.
    Nodes: l1, l2, ..., ln, r1, r2, ..., rn.
    Edges:
      For i in 1..(n-1): add edge from l_i to l_{i+1} and from l_i to r_i.
      And add an edge from l_n to r_n.
    """
    G = nx.DiGraph()
